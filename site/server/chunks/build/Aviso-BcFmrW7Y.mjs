import { mergeProps, useSSRContext } from 'file:///home/maga/dev/sirius5/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderSlot } from 'file:///home/maga/dev/sirius5/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "alert bg-blue-100 text-orange-400 p-4 rounded" }, _attrs))} data-v-6bf80314>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/global/Aviso.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const Aviso = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6bf80314"]]);

export { Aviso as default };
//# sourceMappingURL=Aviso-BcFmrW7Y.mjs.map
