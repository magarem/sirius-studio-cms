import { M as withBase, w as hash, y as withLeadingSlash, o as joinURL, z as withoutTrailingSlash } from '../nitro/nitro.mjs';
import { u as useRuntimeConfig } from './server.mjs';
import { u as useRequestEvent, a as useContentPreview } from './preview-DBzy3xpV.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-oBJA1qCl.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-CoHg93T8.mjs.map
