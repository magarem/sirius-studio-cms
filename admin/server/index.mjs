import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, isEvent, createEvent, fetchWithEvent, defineEventHandler, handleCacheHeaders, eventHandler, getResponseStatus, setResponseHeaders, setHeaders, sendRedirect, proxyRequest, createError, getQuery as getQuery$1, getRequestURL, getCookie, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, readBody, getResponseStatusText } from 'file:///home/maga/dev/sirius-studio-cms/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { mkdirSync } from 'node:fs';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { threadId, parentPort } from 'node:worker_threads';
import _RemarkEmoji from 'file:///home/maga/dev/sirius-studio-cms/node_modules/remark-emoji/index.js';
import { createStorage, prefixStorage } from 'file:///home/maga/dev/sirius-studio-cms/node_modules/unstorage/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL, withLeadingSlash, withoutTrailingSlash, isRelative } from 'file:///home/maga/dev/sirius-studio-cms/node_modules/ufo/dist/index.mjs';
...
import { basename, extname } from 'file:///home/maga/dev/sirius-studio-cms/node_modules/pathe/dist/index.mjs';
import { snakeCase, kebabCase, pascalCase, camelCase } from 'file:///home/maga/dev/sirius-studio-cms/node_modules/scule/dist/index.mjs';
import { unified } from 'file:///home/maga/dev/sirius-studio-cms/node_modules/unified/index.js';
import { toString as toString$1 } from 'file:///home/maga/dev/sirius-studio-cms/node_modules/mdast-util-to-string/index.js';
import { postprocess, preprocess } from 'file:///home/maga/dev/sirius-studio-cms/node_modules/micromark/dev/index.js';
import { stringifyPosition } from 'file:///home/maga/dev/sirius-studio-cms/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file:///home/maga/dev/sirius-studio-cms/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file:///home/maga/dev/sirius-studio-cms/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file:///home/maga/dev/sirius-studio-cms/node_modules/micromark-util-resolve-all/index.js';
import { normalizeUri } from 'file:///home/maga/dev/sirius-studio-cms/node_modules/micromark-util-sanitize-uri/dev/index.js';
...
import destr, { destr as destr$1 } from 'file:///home/maga/dev/sirius-studio-cms/node_modules/destr/dist/index.mjs';
import slugify from 'file:///home/maga/dev/sirius-studio-cms/node_modules/slugify/slugify.js';
import fs$1, { readFile, writeFile } from 'fs/promises';
import path, { resolve, join as join$1 } from 'path';
...
import yaml$1 from 'file:///home/maga/dev/sirius-studio-cms/node_modules/js-yaml/dist/js-yaml.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///home/maga/dev/sirius-studio-cms/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///home/maga/dev/sirius-studio-cms/node_modules/devalue/index.js';
import { renderToString } from 'file:///home/maga/dev/sirius-studio-cms/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file:///home/maga/dev/sirius-studio-cms/node_modules/@unhead/ssr/dist/index.mjs';
...
import { consola } from 'file:///home/maga/dev/sirius-studio-cms/node_modules/consola/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/maga/dev/sirius-studio-cms/node_modules/errx/dist/index.js';
import { isVNode, unref, version } from 'file:///home/maga/dev/sirius-studio-cms/node_modules/vue/index.mjs';
import { getIcons } from 'file:///home/maga/dev/sirius-studio-cms/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file:///home/maga/dev/sirius-studio-cms/.admin-build/nuxt-icon-server-bundle.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///home/maga/dev/sirius-studio-cms/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///home/maga/dev/sirius-studio-cms/node_modules/@unhead/shared/dist/index.mjs';
...
const _MpQ77gN2Hn = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/home/maga/dev/sirius-studio-cms";
...
storage$1.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"/home/maga/dev/sirius-studio-cms/content","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"/home/maga/dev/sirius-studio-cms/.admin-build/content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/maga/dev/sirius-studio-cms","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/maga/dev/sirius-studio-cms/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/maga/dev/sirius-studio-cms/.admin-build","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/maga/dev/sirius-studio-cms/.admin-build/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/maga/dev/sirius-studio-cms/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _ilKpOtZEEG = defineNitroPlugin(async (nitro) => {
...
const _lazy_bvzhkK = () => Promise.resolve().then(function () { return addNode$1; });
const _lazy_sZWICL = () => Promise.resolve().then(function () { return compileContent$1; });
const _lazy_KQUbUs = () => Promise.resolve().then(function () { return _id_$1; });
const _lazy_mNmBDs = () => Promise.resolve().then(function () { return findItemByPath$2; });
const _lazy_IqMOTj = () => Promise.resolve().then(function () { return generate_post$1; });
const _lazy_1cWbe4 = () => Promise.resolve().then(function () { return getNode$3; });
const _lazy_Ybt9O9 = () => Promise.resolve().then(function () { return getNode$1; });
const _lazy_P7z4yA = () => Promise.resolve().then(function () { return getNodeByPath$1; });
const _lazy_KMMdsk = () => Promise.resolve().then(function () { return ____path_$1; });
const _lazy_Pte2GU = () => Promise.resolve().then(function () { return getPage$1; });
const _lazy_WLMzJt = () => Promise.resolve().then(function () { return getRecord$2; });
const _lazy_iO7byl = () => Promise.resolve().then(function () { return manageNode$1; });
const _lazy_DYdzi3 = () => Promise.resolve().then(function () { return manageSqlite$1; });
const _lazy_F6Wjts = () => Promise.resolve().then(function () { return nodes$1; });
const _lazy_AuWgwX = () => Promise.resolve().then(function () { return parseFrontmatter_post$1; });
const _lazy_uu7spS = () => Promise.resolve().then(function () { return saveNodes_post$1; });
const _lazy_nmkUAi = () => Promise.resolve().then(function () { return upsertSqlite$1; });
const _lazy_WiyjYy = () => Promise.resolve().then(function () { return upsertNode$1; });
const _lazy_5DqzJw = () => Promise.resolve().then(function () { return renderer$1; });
...
const handlers = [
  ...
  { route: '/api/_content/cache.json', handler: _RXxQ9H, lazy: false, middleware: false, method: "get" },
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file:///home/maga/dev/sirius-studio-cms/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const addNode$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: addNode
});
...
const compileContent$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: compileContent
});

const _id_ = defineEventHandler((event) => {
  const dbPath = join$1(process.cwd(), "data", "content.db");
...
const findItemByPath$2 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: findItemByPath$1
});
...
const generate_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: generate_post
});

const getNode$2 = defineEventHandler(async (event) => {
  const { _path } = getQuery$1(event);
  if (!_path) {
...
const getNode$3 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: getNode$2
});
...
const getNode$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: getNode
});
...
const getNodeByPath = defineEventHandler(async (event) => {
  ...
  const nodes = JSON.parse(await readFile(join$1(process.cwd(), "server/data/nodes.json"), "utf-8"));
...
const getNodeByPath$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: getNodeByPath
});
...
const ____path_ = defineEventHandler(async (event) => {
  ...
  const filePath = join$1(process.cwd(), "server/data/nodes.json");
...
const getPage$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: getPage
});

const getRecord$1 = defineEventHandler(async (event) => {
  const query = getQuery$1(event);
  const { _id } = query;
  if (!_id) {
    throw createError({
...
const getRecord$2 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: getRecord$1
});

const filePath = join$1(process.cwd(), "public", "data", "nodes.json");
...
const manageNode$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: manageNode
});

const dbPath$1 = join$1(process.cwd(), "data", "nodes_contents.db");
const initializeDatabase$1 = () => {
  const db = new sqlite3.Database(dbPath$1);
  db.serialize(() => {
    db.run(
...
const upsertContent$1 = (_id, _type, label, content) => {
  return new Promise((resolve, reject) => {
    const db = new sqlite3.Database(dbPath$1);
    const query = `
...
const manageSqlite = defineEventHandler(async (event) => {
  ...
  try {
    ...
    if (action === "save") {
      await upsertContent$1(_id, _type, label, content);
...
const manageSqlite$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: manageSqlite
});
...
const nodes$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: nodes
});
...
const parseFrontmatter_post = defineEventHandler(async (event) => {
  ...
  try {
    ...
    const frontmatterObject = yaml$1.load(frontmatterContent);
...
const parseFrontmatter_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: parseFrontmatter_post
});
...
const saveNodes_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: saveNodes_post
});

const dbPath = join$1(process.cwd(), "public", "data", "nodes_contents.db");
...
const upsertSqlite$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: upsertSqlite
});
...
const upsertNode = defineEventHandler(async (event) => {
  ...
  try {
    let jsonData;
    try {
      const fileContent = await fs$1.readFile(jsonFilePath, "utf-8");
    ...
    await fs$1.writeFile(jsonFilePath, JSON.stringify(jsonData, null, 2), "utf-8");
...
const upsertNode$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: upsertNode
});
...
const getClientManifest = () => import('file:///home/maga/dev/sirius-studio-cms/.admin-build/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///home/maga/dev/sirius-studio-cms/.admin-build/dist/server/server.mjs').then((r) => r.default || r);
